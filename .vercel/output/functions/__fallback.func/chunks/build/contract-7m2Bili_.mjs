...
import {
  ...
  _ as _sfc_main$2,
  c as useWalletStore,
  d as getPublicClient,
  p as parseWeb3Error,
  e as getUserFriendlyErrorMessage,
  f as createWalletClientForChain,
} from "./WalletButton-B8d8q0EA.mjs";
import {
  defineComponent,
  ref,
  computed,
...
function useContractWrite(config) {
  ...
  async function write(params) {
    ...
    try {
      ...
      uiStore.showError(
        "Transaction failed",
        getUserFriendlyErrorMessage(parsedError)
      );
      throw parsedError;
    } finally {
  ...
  setup(__props) {
    ...
    const isDecrementDisabled = computed(() => {
      ...
      return (
        !isOnSepolia.value ||
        writeLoading.value ||
        ((_a = counterData.value) == null ? void 0 : _a.isLoading)
      );
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        `<div${ssrRenderAttrs(mergeProps({ class: "counter-page" }, _attrs))}><div class="page-header"><div class="page-header__content"><div><h1 class="page-title">Smart Contract Counter</h1><p class="page-description"> Interact with the deployed counter contract on the blockchain </p></div>`
      );
      if (unref(isConnected)) {
        _push(
          `<div class="page-header__badge"><div class="status-indicator status-indicator--connected"></div><span>Connected</span></div>`
        );
      } else {
        _push(`<!---->`);
      }
      ...
      if (!unref(isConnected)) {
        _push(
          ssrRenderComponent(
            _component_Web3WalletNotConnected,
            null,
            null,
            _parent
          )
        ...
        _push(
          `<div class="content-grid"><div class="counter-card"><div class="counter-card__header"><h2>Current Value</h2><button class="icon-button"${ssrIncludeBooleanAttr(isRefreshDisabled.value) ? " disabled" : ""}><svg class="${ssrRenderClass({ spin: (_a = counterData.value) == null ? void 0 : _a.isLoading })}" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.8333 10C15.8333 13.2217 13.2217 15.8333 10 15.8333C6.77834 15.8333 4.16667 13.2217 4.16667 10C4.16667 6.77834 6.77834 4.16667 10 4.16667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13.3333 4.16667H15.8333V6.66667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></button></div><div class="counter-display">`
        );
        if ((_b = counterData.value) == null ? void 0 : _b.isLoading) {
          _push(
            `<div class="counter-value counter-value--loading"><div class="spinner"></div></div>`
          );
        } else {
          _push(
            `<div class="counter-value"><span class="counter-number">${ssrInterpolate(((_d = (_c = counterData.value) == null ? void 0 : _c.data) == null ? void 0 : _d.toString()) || 0)}</span></div>`
          );
        }
        _push(`</div>`);
        if (!isOnSepolia.value) {
          _push(
            `<div class="network-warning"><div class="network-warning__icon">`
          );
          _push(
            ssrRenderComponent(_component_Icon, { name: "info" }, null, _parent)
          );
          _push(
            `</div><div class="network-warning__content"><h4>Wrong Network</h4><p> This Contract is deployed on Sepolia testnet. Please switch to Sepolia to interact with it. </p></div></div>`
          );
        } else {
          _push(`<!---->`);
        }
        _push(
          `<div class="counter-actions"><button${ssrIncludeBooleanAttr(isDecrementDisabled.value) ? " disabled" : ""} class="counter-button counter-button--decrement"><span class="counter-button__icon">`
        );
        _push(
          ssrRenderComponent(_component_Icon, { name: "minus" }, null, _parent)
        );
        _push(
          `</span><span class="counter-button__text">Decrement</span></button><button${ssrIncludeBooleanAttr(isIncrementDisabled.value) ? " disabled" : ""} class="counter-button counter-button--increment"><span class="counter-button__icon">`
        );
        _push(
          ssrRenderComponent(_component_Icon, { name: "plus" }, null, _parent)
        );
        _push(
          `</span><span class="counter-button__text">Increment</span></button></div>`
        );
        if (txHash.value) {
          _push(
        ...
        _push(
          `</div><div class="events-card"><div class="events-card__header"><h2>Recent Events</h2><button class="btn-ghost btn-sm"${ssrIncludeBooleanAttr(!isOnSepolia.value) ? " disabled" : ""}> Clear All </button></div>`
        );
        if (!isOnSepolia.value) {
          _push(
            `<div class="network-warning"><div class="network-warning__icon">`
          ...
          _push(
            `<h4>No Events Yet</h4><p>Increment or decrement the counter to see blockchain events</p></div>`
          );
        } else {
          ...
          ssrRenderList(events.value.slice(0, 10), (event, index) => {
            var _a2;
            _push(
              `<div class="event-item"><div class="${ssrRenderClass([`event-item__icon--${event.eventName === "Increament" ? "increment" : "decrement"}`, "event-item__icon"])}">`
            );
...
//# sourceMappingURL=contract-7m2Bili_.mjs.map
