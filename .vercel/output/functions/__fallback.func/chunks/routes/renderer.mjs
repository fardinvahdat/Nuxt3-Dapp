...
import { j as joinRelativeURL, u as useRuntimeConfig, d as defineRenderHandler, g as getQuery, c as createError, a as getRouteRules, b as joinURL, e as useNitroApp, f as getResponseStatusText, h as getResponseStatus } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Production-ready modular DApp architecture built with Nuxt 3"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Nuxt DApp Architecture"};
...
const entryFileName = "S0ch9O2d.js";
